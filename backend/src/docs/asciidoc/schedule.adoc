...
include::{snippets}/schedules/scheduling/http-request.adoc[]

==== Parameters

include::{snippets}/schedules/scheduling/path-parameters.adoc[]

include::{snippets}/schedules/scheduling/request-parameters.adoc[]

==== Response

include::{snippets}/schedules/scheduling/http-response.adoc[]
