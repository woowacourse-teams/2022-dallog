...
public class MemberFixtures {
    ...
    public static Member 관리자() {
        return new Member(관리자_이메일, 관리자_이름, 관리자_프로필, SocialType.GOOGLE);
    }

    public static Member 파랑() {
        return new Member(파랑_이메일, 파랑_이름, 파랑_프로필, SocialType.GOOGLE);
    }

    public static Member 리버() {
        return new Member(리버_이메일, 리버_이름, 리버_프로필, SocialType.GOOGLE);
    }

    public static Member 후디() {
        return new Member(후디_이메일, 후디_이름, 후디_프로필, SocialType.GOOGLE);
    }

    public static Member 매트() {
        return new Member(매트_이메일, 매트_이름, 매트_프로필, SocialType.GOOGLE);
    }
}
