...
public class Constants {
    ...
    public static final String MEMBER_프로필_URL = "/member.png";
    public static final String MEMBER_REFRESH_TOKEN = "aaaaaaaaaa.bbbbbbbbbb.cccccccccc";
    public static final OAuthMember oAuthMember = new OAuthMember(MEMBER_이메일, MEMBER_이름, MEMBER_프로필_URL,
    ...
    public static final String 박람회_카테고리_이름 = "박람회 카테고리";
    public static final String 대학입시_카테고리_이름 = "대학입시 카테고리";
