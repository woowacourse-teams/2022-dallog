...
class IntegrationScheduleDaoTest {
    ...
    void 카테고리와_시작일시_종료일시를_전달하면_그_사이에_해당하는_일정을_조회한다() {
        ...
        // when
        List<IntegrationSchedule> actual = integrationScheduleDao.findByCategoryIdInAndBetween(List.of(BE_일정.getId()),
    ...
    void 조회하기_위한_category_id의_크기가_0인_경우_빈_리스트를_반환한다() {
        ...
        LocalDateTime endDateTime = 날짜_2022년_7월_31일_0시_0분;
    ...
    void 카테고리가_여러_개_일_때_카테고리_id_리스트와_시작일시_종료일시를_전달하면_그_사이에_해당하는_일정을_조회한다() {
        ...
        List<Long> categoryIds = List.of(BE_일정.getId(), FE_일정.getId(), 매트_아고라.getId());
        LocalDateTime startDateTime = 날짜_2022년_7월_1일_0시_0분;
        LocalDateTime endDateTime = 날짜_2022년_7월_31일_0시_0분;
    ...
    void 시작일시와_종료일시를_전달할_때_일정의_시작일시와_같으면_조회된다() {
        ...
        List<Long> categoryIds = List.of(BE_일정.getId());
        LocalDateTime startDateTime = 날짜_2022년_7월_1일_0시_0분;
        LocalDateTime endDateTime = 날짜_2022년_7월_15일_16시_0분;
    ...
    void 카테고리와_시작일시와_종료일시를_전달할_때_일정의_종료날짜가_시작일시와_같으면_조회된다() {
        ...
        List<Long> categoryIds = List.of(BE_일정.getId());
        LocalDateTime startDateTime = 날짜_2022년_7월_16일_16시_0분;
        LocalDateTime endDateTime = 날짜_2022년_7월_31일_0시_0분;
